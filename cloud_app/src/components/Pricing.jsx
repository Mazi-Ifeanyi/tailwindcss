...
const Pricing = () => {
  return (
    <div name='pricing' className='w-full text-white my-24'>
        <span className='w-full h-[800px] bg-slate-900 absolute mix-blend-overlay'>
        ...
        <div className='max-w[1240px] mx-auto py-12'>
            <div className='text-center py-8 text-slate-300'>
                ...
                <p className='text-3xl'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta recusandae deleniti maiores consectetur accusantium molestias possimus adipisci iusto quam ipsum?</p>
            </div>
            ...
            <div className='grid md:grid-cols-2'>
                <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    ...
                    <div className='text-2xl'>
                        <p className='flex py-4'><FcCheckmark className='mr-3 mt-2' />Lorem, ipsum dolor.</p>
                        <p className='flex py-4'><FcCheckmark className='mr-3 mt-2' />Lorem, ipsum dolor.</p>
                        <p className='flex py-4'><FcCheckmark className='mr-3 mt-2' />Lorem, ipsum dolor.</p>
                        <p className='flex py-4'><FcCheckmark className='mr-3 mt-2' />Lorem, ipsum dolor.</p>
                        <p className='flex py-4'><FcCheckmark className='mr-3 mt-2' />Lorem, ipsum dolor.</p>
